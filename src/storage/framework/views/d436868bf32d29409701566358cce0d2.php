...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative min-h-screen flex items-center bg-sbk-black overflow-x-hidden" x-data="{
        current: 0,
        total: <?php echo e($heroImages->count() > 0 ? $heroImages->count() : 1); ?>,
        timer: null,
        init() {
            if (this.total > 1) {
        ...
        <div class="absolute inset-0 z-0">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroImages->count()): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $heroImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div x-show="current === <?php echo e($idx); ?>" x-transition:enter="transition-opacity duration-1000"
                        x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                        x-transition:leave="transition-opacity duration-1000" x-transition:leave-start="opacity-100"
                        x-transition:leave-end="opacity-0" class="absolute inset-0"
                        <?php echo e($idx === 0 ? '' : 'style=display:none'); ?>>
                        <img src="<?php echo e(Storage::url($heroImg->image_path)); ?>" alt="" width="1920" height="1080"
                            sizes="100vw" loading="<?php echo e($idx === 0 ? 'eager' : 'lazy'); ?>"
                            fetchpriority="<?php echo e($idx === 0 ? 'high' : 'auto'); ?>" decoding="async" aria-hidden="true"
            ...
            <?php else: ?>
                ...
                <img src="<?php echo e($heroImage); ?>" alt="" width="1920" height="1080" sizes="100vw" loading="eager"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroImages->count() > 1): ?>
                <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-2 z-20">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $heroImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <button
                            @click="current = <?php echo e($idx); ?>; clearInterval(timer); timer = setInterval(() => { current = (current + 1) % total; }, 5000)"
                            :class="current === <?php echo e($idx); ?> ? 'bg-white w-6' : 'bg-white/40 w-2'"
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-8">
                    <div data-reveal="fade-down"
                        ...
                        <span class="text-sbk-red font-semibold text-xs uppercase tracking-widest">
                            <?php echo e($setting->hero_badge_text); ?>
                    ...
                    <div data-reveal="fade-up" data-delay="100">
                        <h1 class="font-heading font-black leading-[1.0] mb-2">
                            <span
                                class="block text-white text-4xl sm:text-5xl lg:text-7xl"><?php echo e($setting->hero_title_line1); ?></span>
                            <span
                                class="block text-sbk-red text-4xl sm:text-5xl lg:text-7xl"><?php echo e($setting->hero_title_line2); ?></span>
                            <span
                                class="block text-white text-4xl sm:text-5xl lg:text-7xl"><?php echo e($setting->hero_title_line3); ?></span>
                        </h1>
                    </div>

                    <p data-reveal="fade-up" data-delay="200"
                        class="text-gray-300 text-lg italic font-light border-l-2 border-sbk-red pl-4">
                        "<?php echo e($setting->hero_tagline); ?>"
                    </p>

                    <p data-reveal="fade-up" data-delay="300" class="text-gray-400 leading-relaxed max-w-lg">
                        <?php echo e($setting->hero_description); ?>

                    </p>

                    <div data-reveal="fade-up" data-delay="400"
                        class="grid grid-cols-3 gap-6 py-6 border-y border-white/10">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [[$setting->stat_clients . '+', $setting->stat_clients_label], [$setting->stat_projects . '+', $setting->stat_projects_label], [$setting->stat_services . '+', $setting->stat_services_label]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="text-center">
                                <p class="font-heading font-black text-4xl text-sbk-red"><?php echo e($s[0]); ?></p>
                                <p class="text-gray-500 text-xs uppercase tracking-widest mt-1"><?php echo e($s[1]); ?></p>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>

                    <div data-reveal="fade-up" data-delay="500" class="flex flex-wrap gap-4">
                        <a href="<?php echo e(route('services')); ?>" class="btn-primary text-sm">
                            <?php echo e($setting->hero_btn_primary_text); ?>
                        ...
                        <a href="<?php echo e($waUrl); ?>" target="_blank" rel="noopener noreferrer"
                            ...
                            <?php echo e($setting->hero_btn_secondary_text); ?>
                ...
                <div data-reveal="fade-left" data-delay="300" class="hidden lg:block relative h-[420px]">
                    <div
                        ...
                        <img src="<?php echo e($displayLogo); ?>" alt="Logo PT Sastra Bhinneka Karya" width="256" height="256"
                        ...
                        <div class="absolute -top-6 -left-6 bg-sbk-red rounded-2xl px-5 py-3">
                            <p class="text-white font-heading font-black text-2xl"><?php echo e($setting->stat_clients); ?>+</p>
                            <p class="text-white/70 text-xs"><?php echo e($setting->stat_clients_label); ?></p>
                        </div>
                        <div class="absolute -bottom-6 -right-6 bg-white rounded-2xl px-5 py-3">
                            <p class="text-sbk-red font-heading font-black text-2xl"><?php echo e($setting->stat_projects); ?>+</p>
                            <p class="text-gray-500 text-xs"><?php echo e($setting->stat_projects_label); ?></p>
                        </div>
                        <div
                            class="absolute top-1/2 -translate-y-1/2 -right-8 bg-sbk-dark border border-white/10 rounded-2xl px-5 py-3">
                            <p class="text-white font-heading font-black text-2xl"><?php echo e($setting->stat_services); ?>+</p>
                            <p class="text-gray-400 text-xs"><?php echo e($setting->stat_services_label); ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div data-reveal="fade-right" class="relative">
                    <div class="rounded-3xl overflow-hidden h-[420px]">
                        <img src="<?php echo e($aboutImage); ?>" alt="Tim PT Sastra Bhinneka Karya di area proyek konstruksi"
                    ...
                    <div class="absolute bottom-6 left-6 bg-sbk-red rounded-2xl px-7 py-4 shadow-red-lg">
                        <p x-data="counter(<?php echo e($setting->stat_years); ?>)" x-intersect="start()" x-text="count + '+'"
                            class="font-heading font-black text-3xl text-white">
                        </p>
                        <p class="text-white/70 text-xs uppercase tracking-wider"><?php echo e($setting->stat_years_label); ?></p>
                    </div>
                ...
                <div data-reveal="fade-left" data-delay="200" class="space-y-6">
                    <div>
                        <span class="section-tag"><?php echo e($setting->about_section_tag); ?></span>
                        <h2 class="section-title mt-2">
                            <?php echo e($setting->about_title); ?>

                        </h2>
                    </div>
                    <p class="text-gray-500 leading-relaxed">
                        <?php echo e($setting->about_description); ?>

                    </p>
                    <div class="grid grid-cols-2 gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = is_array($setting->about_highlights) ? $setting->about_highlights : explode("\n", $setting->about_highlights ?? ''); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex items-center gap-3 bg-sbk-gray-light rounded-xl p-3">
                                ...
                                <span class="font-semibold text-sbk-black text-sm"><?php echo e($p); ?></span>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                    <a href="<?php echo e(route('about')); ?>" class="btn-ghost">
                        Selengkapnya
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <section class="py-16 bg-sbk-red relative overflow-hidden">
        ...
        <div class="container-sbk relative">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [[$setting->stat_clients, $setting->stat_clients_label], [$setting->stat_projects, $setting->stat_projects_label], [$setting->stat_services, $setting->stat_services_label], [$setting->stat_years, $setting->stat_years_label]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div data-reveal="fade-up" data-delay="<?php echo e(($i + 1) * 100); ?>" class="group">
                        <p
                            class="font-heading font-black text-5xl lg:text-6xl text-white group-hover:scale-110 transition-transform duration-300">
                            <?php echo e($s[0]); ?>+
                        </p>
                        <p class="text-white/70 text-xs uppercase tracking-widest mt-2 font-semibold"><?php echo e($s[1]); ?>
        ...
        <div class="container-sbk">
            ...
            <div x-show="tab === 'konstruksi'" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $services->where('category', 'construction'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a data-reveal="fade-up" data-delay="<?php echo e((($i % 3) + 1) * 100); ?>"
                            href="<?php echo e(route('services')); ?>#service-<?php echo e($service->id); ?>"
                            ...
                            <div
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->image_path): ?>
                                    <img src="<?php echo e(Storage::url($service->image_path)); ?>" alt="<?php echo e($service->title); ?>"
                                ...
                                <div class="absolute top-3 left-3 bg-black/40 backdrop-blur-sm rounded-lg px-2 py-1">
                                    <span
                                        class="text-white/70 font-heading font-black text-sm"><?php echo e(str_pad($i + 1, 2, '0', STR_PAD_LEFT)); ?></span>
                                </div>
                            ...
                            <div class="p-6 flex flex-col flex-1">
                                ...
                                <p class="text-gray-400 text-sm leading-relaxed flex-1 line-clamp-2">
                                    <?php echo e(Str::limit(strip_tags($service->description), 80) ?? '-'); ?></p>
                                <div
            ...
            <div x-show="tab === 'non'" x-transition:enter="transition ease-out duration-300"
                ...
                style="display:none;">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $services->where('category', 'non-construction'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a data-reveal="fade-up" data-delay="<?php echo e((($i % 3) + 1) * 100); ?>"
                            href="<?php echo e(route('services')); ?>#service-<?php echo e($service->id); ?>"
                            class="group bg-sbk-gray rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 flex flex-col">
                            <div
    ...
    <section class="section-padding bg-white overflow-hidden">
        ...
        <?php $clientList = $clients->count() ? $clients : collect([]); ?>
        ...
        <div class="relative mb-4" x-data="{ paused: false }">
            ...
            <div class="flex gap-4 marquee-left" :class="paused ? 'paused' : ''" @mouseenter="paused = true"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($r = 0; $r < 2; $r++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($clientList->count()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $clientList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->logo): ?>
                                    <img src="<?php echo e(Storage::url($client->logo)); ?>" alt="Logo <?php echo e($client->name); ?>"
                                ...
                                <?php else: ?>
                                    <div class="text-center">
                                        <div
                                            ...
                                            <span
                                                class="font-heading font-black text-sbk-red group-hover:text-white text-sm transition-colors"><?php echo e(strtoupper(substr($client->name, 3, 1))); ?></span>
                                        </div>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <?php else: ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['NSI', 'WC', 'YLI', 'HIS', 'HRE', 'TB', 'GSI', 'ICM', 'AMU', 'SIX', 'ABI', 'SCM']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abbr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        class="font-heading font-black text-sbk-red group-hover:text-white text-sm transition-colors"><?php echo e($abbr[0]); ?></span>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="relative" x-data="{ paused: false }">
            ...
            <div class="flex gap-4 marquee-right" :class="paused ? 'paused' : ''" @mouseenter="paused = true"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($r = 0; $r < 2; $r++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($clientList->count()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $clientList->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <?php else: ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['SCM', 'ABI', 'SIX', 'AMU', 'ICM', 'GSI', 'TB', 'HRE', 'HIS', 'YLI', 'WC', 'NSI']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abbr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div
    ...
    <section class="section-padding bg-sbk-gray-light">
        <div class="container-sbk">
            <div data-reveal="fade-up" class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
                ...
                <a href="<?php echo e(route('portfolio')); ?>" class="btn-outline self-start">
                    Semua Portofolio
            ...
            <div x-data="{
                items: <?php echo e(Js::from($rawItems)); ?>,
                current: 0,
                timer: null,
                interval: 3000,
                getItem(offset) {
                ...
                <div class="flex flex-col lg:flex-row gap-3">
                    ...
                    <div class="relative rounded-xl overflow-hidden bg-sbk-black border border-white/5 cursor-pointer"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rawItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['image']): ?>
                                <img src="<?php echo e($item['image']); ?>" alt="<?php echo e($item['name']); ?>" width="900"
                                    height="720" loading="<?php echo e($idx === 0 ? 'eager' : 'lazy'); ?>" decoding="async"
                                    ...
                                    :class="current === <?php echo e($idx); ?> ? 'scale-105' : 'scale-100'"
                                    style="z-index: 1;">
                            <?php else: ?>
                    ...
                    <div class="grid grid-cols-2 gap-3" style="flex: 1;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [1, 2, 3, 4]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="group relative rounded-xl overflow-hidden bg-sbk-black border border-white/5 cursor-pointer"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rawItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['image']): ?>
                                        <img src="<?php echo e($item['image']); ?>" alt="<?php echo e($item['name']); ?>" width="480"
                                            height="280" loading="lazy" decoding="async"
                                            x-show="(current + <?php echo e($offset); ?>) % items.length === <?php echo e($idx); ?>"
                                            ...
                                            style="z-index: 1;">
                                    <?php else: ?>
                                        <div x-show="(current + <?php echo e($offset); ?>) % items.length === <?php echo e($idx); ?>"
                                            x-transition:enter="transition-opacity duration-500 ease-in-out"
                                            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                                            x-transition:leave="transition-opacity duration-300 ease-in-out"
                                            x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                                ...
                                :href="getItem(<?php echo e($offset); ?>).url"
                                ...
                                <div class="absolute bottom-0 left-0 right-0 p-4 transform transition-transform duration-500 ease-in-out group-hover:-translate-y-2"
                                    ...
                                    <span
                                        ...
                                        x-text="getItem(<?php echo e($offset); ?>).period"></span>
                                    <h4 class="font-heading font-bold text-white text-sm leading-snug mb-1"
                                        x-text="getItem(<?php echo e($offset); ?>).name"></h4>
                                    <p class="text-gray-300 text-xs" x-text="getItem(<?php echo e($offset); ?>).client"></p>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                ...
                <div class="flex items-center justify-center gap-4 mt-6">
                    ...
                    <div class="flex gap-1.5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rawItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <button @click="current = <?php echo e($idx); ?>; resetTimer()"
                                :class="current === <?php echo e($idx); ?> ? 'bg-sbk-red w-5' : 'bg-gray-400/40 w-2'"
                                class="h-2 rounded-full transition-all duration-300"
                                aria-label="Portfolio <?php echo e($idx + 1); ?>"></button>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
        ...
        <section class="section-padding bg-white">
            <div class="container-sbk">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $testimonials->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div data-reveal="fade-up" data-delay="<?php echo e(($i + 1) * 100); ?>"
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed mb-6"><?php echo e($t->content); ?></p>
                            <div class="flex gap-1 mb-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($star = 0; $star < $t->rating; $star++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
                                <div
                                    ...
                                    <span class="text-white font-bold text-sm"><?php echo e(substr($t->client_name, 0, 1)); ?></span>
                                </div>
                                <div>
                                    <p class="font-bold text-sbk-black text-sm"><?php echo e($t->client_name); ?></p>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($t->position): ?>
                                        <p class="text-gray-400 text-xs"><?php echo e($t->position); ?> — <?php echo e($t->company); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </div>
    ...
    <section class="py-24 relative overflow-hidden">
        ...
        <div data-reveal="fade-up" class="container-sbk text-center relative z-10">
            <div class="max-w-3xl mx-auto space-y-6">
                <span class="section-tag justify-center text-sbk-red"><?php echo e($setting->cta_section_tag); ?></span>
                <?php
                ...
                <h2 class="font-heading font-black text-4xl lg:text-6xl text-black mt-2">
                    <?php echo e($ctaPrefix); ?><span class="text-sbk-red"><?php echo e($ctaHighlight); ?></span>
                </h2>
                <p class="text-gray-400 text-lg leading-relaxed">
                    <?php echo e($setting->cta_description); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center pt-2">
                    <a href="<?php echo e($waUrl); ?>" target="_blank" rel="noopener noreferrer"
                        ...
                        <?php echo e($setting->cta_btn_text); ?>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-xs leading-relaxed"><?php echo e($setting->contact_address); ?></p>
                            </div>
                        </div>
                        <div
                            class="bg-sbk-gray-light rounded-lg p-5 flex items-center gap-4 border border-gray-100 shadow-sm">
                            ...
                            <div>
                                ...
                                <a href="tel:+<?php echo e(preg_replace('/[^0-9]/', '', $setting->contact_phone)); ?>"
                                    class="text-gray-500 text-xs hover:text-sbk-red transition-colors"><?php echo e($setting->contact_phone); ?></a>
                            </div>
                        </div>
                        <div
                            class="bg-sbk-gray-light rounded-lg p-5 flex items-center gap-4 border border-gray-100 shadow-sm">
                            ...
                            <div>
                                ...
                                <a href="mailto:<?php echo e($setting->contact_email); ?>"
                                    class="text-gray-500 text-xs hover:text-sbk-red transition-colors break-all"><?php echo e($setting->contact_email); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="rounded-lg overflow-hidden flex-1 min-h-[350px] border border-gray-200 shadow-sm">
                        <iframe src="<?php echo e($setting->contact_maps_embed_url); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/home.blade.php ENDPATH**/ ?>