...
<?php $__env->startSection('content'); ?>
    ...
    <section id="konstruksi" class="section-padding bg-white">
        <div class="container-sbk">
            ...
            <div class="space-y-3" x-data="{ open: null }">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $construction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div id="service-<?php echo e($service->id); ?>"
                        ...
                        <button @click="open === <?php echo e($i); ?> ? open = null : open = <?php echo e($i); ?>"
                            ...
                            <div class="w-8 h-8 bg-sbk-gray-light rounded-full flex items-center justify-center flex-shrink-0 ml-4
                                ...
                                :class="open === <?php echo e($i); ?> ? 'bg-sbk-red rotate-45' : ''">
                                <svg class="w-4 h-4 transition-colors"
                                    :class="open === <?php echo e($i); ?> ? 'text-white' : 'text-gray-400'" fill="none"
                        ...
                        <div x-show="open === <?php echo e($i); ?>" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="pl-14 border-t border-gray-100 pt-5">
                                ...
                                <div class="prose prose-sm max-w-none text-gray-500 leading-relaxed">
                                    <?php echo $service->description ?? 'Layanan profesional yang didukung oleh tim ahli berpengalaman.'; ?>

                                </div>
                                <a href="https://api.whatsapp.com/send?phone=6281312023435&text=<?php echo e(urlencode('Halo Tim Sastra Bhinneka Karya, saya tertarik dengan layanan ' . $service->title . ' dan ingin konsultasi lebih lanjut.')); ?>"
                                    target="_blank"
    ...
    <section id="non-konstruksi" class="section-padding bg-sbk-gray-light">
        <div class="container-sbk">
            ...
            <div class="space-y-3" x-data="{ open: null }">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $nonConstruction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div id="service-<?php echo e($service->id); ?>"
