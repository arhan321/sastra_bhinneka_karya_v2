...
<?php $__env->startSection('content'); ?>
    ...
    <section class="bg-sbk-black py-32 relative overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="<?php echo e(asset('images/construction-site.jpg')); ?>" class="w-full h-full object-cover" alt="Construction Site">
        ...
        <div class="container-sbk relative z-20">
            ...
            <div class="flex items-center gap-3 mt-6" data-reveal="fade-up" data-delay="200">
                <a href="<?php echo e(route('home')); ?>" class="text-gray-400 text-sm hover:text-white transition-colors">
                    Beranda
                </a>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="relative" data-reveal="fade-right">
                    <div class="bg-sbk-gray-light rounded-3xl p-10 flex items-center justify-center min-h-80">
                        <img src="<?php echo e($companyLogo); ?>" alt="SBK Logo" class="max-w-xs w-full object-contain" loading="lazy"
                            onerror="this.onerror=null;this.src='<?php echo e(asset('images/logo.jpg')); ?>';">
                    </div>
                ...
                <div class="space-y-6" data-reveal="fade-left" data-delay="200">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($company?->history)): ?>
                        <p class="text-gray-500 leading-relaxed">
                            <?php echo e($company->history); ?>
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <span class="text-gray-600 text-sm">
                            <?php echo e($company?->address ?? 'Jl. Merak No. 78 Sukamulya, Kab. Tangerang, Banten 15612'); ?>
        ...
        <div class="container-sbk">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-3xl p-10 shadow-soft" data-reveal="fade-right" data-delay="100">
                    ...
                    <p class="text-gray-500 leading-relaxed">
                        <?php echo e($company?->vision ?? 'Menjadi perusahaan konsultasi terkemuka yang memberikan solusi inovatif dan berkualitas tinggi.'); ?>
                ...
                <div class="bg-sbk-red rounded-3xl p-10 shadow-red" data-reveal="fade-left" data-delay="200">
                    ...
                    <ul class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $missions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php
                            ...
                            <li class="flex items-start gap-3 text-white/90 text-sm">
                                ...
                                <span><?php echo e($missionText); ?></span>
                            </li>
    ...
    <section class="py-16 bg-sbk-black relative overflow-hidden">
        ...
        <div class="container-sbk relative">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [[$totalClients . '+', 'Klien Aktif'], ['50+', 'Proyek Selesai'], [$totalServices . '+', 'Jenis Layanan'], ['5+', 'Tahun Pengalaman']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="group" data-reveal="fade-up" data-delay="<?php echo e($i * 100); ?>">
                        <p
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="bg-sbk-gray-light rounded-2xl p-8 text-center hover:shadow-card transition-all duration-300 hover:-translate-y-1"
                        ...
                        <h3 class="font-heading font-bold text-sbk-black mb-3"><?php echo e($title); ?></h3>
        ...
        <div class="container-sbk relative z-10">
            <div class="max-w-2xl mx-auto text-center space-y-6" data-reveal="fade-up">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center pt-2">
                    <a href="https://wa.me/<?php echo e($waNumber); ?>?text=<?php echo e($waText); ?>" target="_blank"
