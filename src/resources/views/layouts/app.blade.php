...
<head>
    ...
    <meta property="og:image:alt" content="@yield('og_image_alt', $siteName)">
    ...
    <link rel="preload" as="image" href="{{ asset('images/logo-sbk.png') }}">
        ...
        <div class="container-sbk">
            <div class="flex items-center justify-between h-20">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-3 group">
                    <img src="{{ asset('images/logo-sbk.png') }}" alt="SBK Logo"
                ...
                <div class="hidden lg:flex items-center gap-8">
                    ...
                    <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        <a href="{{ route('services') }}"
                            class="nav-link {{ request()->routeIs('services') ? 'active' : '' }} flex items-center gap-1">
                            Layanan
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                <div class="p-5 border-r border-gray-100">
                                    ...
                                    <div class="space-y-0.5">
                                        @forelse ($navConstruction ?? [] as $service)
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="space-y-0.5">
                                        @forelse ($navNonConstruction ?? [] as $service)
                                            <a href="{{ route('services') }}#service-{{ $service->id }}"
                                                class="flex items-start gap-2.5 px-3 py-2 rounded-xl hover:bg-sbk-red/5 transition-colors group/item">
                                                <div class="w-1 h-1 bg-sbk-red/40 rounded-full mt-2 flex-shrink-0">
                                                </div>
                            ...
                            <div
                                ...
                                <span class="text-xs text-gray-400">{{ $totalServices }}+ jenis layanan
                                    tersedia</span>
                                <a href="{{ route('services') }}"
                    ...
                    <a href="{{ route('portfolio') }}"
                        class="nav-link {{ request()->routeIs('portfolio') ? 'active' : '' }}">Portofolio</a>

                    <a href="{{ route('blog') }}"
                        class="nav-link {{ request()->routeIs('blog*') ? 'active' : '' }}">Blog</a>

                    <a href="{{ route('clients') }}"
                        class="nav-link {{ request()->routeIs('clients') ? 'active' : '' }}">Klien</a>
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-white border-t border-gray-100"
        ...
        <div class="container-sbk pb-8">
            <div class="flex flex-col pt-4">
                ...
                <a href="{{ route('home') }}" class="nav-link py-4 px-2 border-b border-gray-100">
                    Beranda
                </a>

                <a href="{{ route('about') }}" class="nav-link py-4 px-2 border-b border-gray-100">
                    Tentang Kami
                </a>

                {{-- Layanan dengan submenu accordion --}}
                ...
                <a href="{{ route('portfolio') }}" class="nav-link py-4 px-2 border-b border-gray-100">
                    Portofolio
                </a>

                <a href="{{ route('blog') }}" class="nav-link py-4 px-2 border-b border-gray-100">
                    Blog
                </a>

                <a href="{{ route('clients') }}" class="nav-link py-4 px-2 border-b border-gray-100">
                    Klien
                </a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                ...
                <div class="lg:col-span-3">
                    <div class="flex items-center gap-3 mb-6">
                        <img src="{{ asset('images/logo-sbk.png') }}" alt="SBK"
                ...
                <div class="lg:col-span-6">
                    ...
                    <div class="grid grid-cols-2 gap-x-8">
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                @foreach ($footerConstruction ?? [] as $service)
                                    <li>
                                        <a href="{{ route('services') }}#service-{{ $service->id }}"
                                ...
                                <li class="pt-1">
                                    <a href="{{ route('services') }}#konstruksi"
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                @foreach ($footerNonConstruction ?? [] as $service)
                                    <li>
                                        <a href="{{ route('services') }}#service-{{ $service->id }}"
                                            class="text-gray-400 text-sm hover:text-sbk-red transition-colors leading-snug block">
                                            {{ $service->title }}
                                ...
                                <li class="pt-1">
                                    <a href="{{ route('services') }}#non-konstruksi"
                                        class="text-sbk-red text-xs font-bold hover:underline">
                                        Lihat semua →
                                    </a>
                                </li>
        ...
        <div class="border-t border-white/10">
            <div class="container-sbk py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                <p class="text-gray-500 text-xs">
                    &copy; {{ date('Y') }} PT Sastra Bhinneka Karya. All rights reserved.
                </p>
                <p class="text-gray-500 text-xs">
