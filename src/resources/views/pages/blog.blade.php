    ...
    <section class="bg-sbk-black py-32 relative overflow-hidden">
        ...
        <div class="container-sbk relative z-20" data-reveal="fade-up">
            ...
            <div class="flex items-center gap-3 mt-6">
                <a href="{{ route('home') }}" class="text-gray-400 text-sm hover:text-white">Beranda</a>
                    ...
                    @if ($posts->count())
                        <div class="grid md:grid-cols-2 gap-6">
                            @foreach ($posts as $i => $post)
                                <a href="{{ route('blog.show', $post->slug) }}" data-reveal="fade-up"
                                        ...
                                        @if ($post->category)
                                            <div class="absolute top-3 left-3">
                                                <span
                                                   ...
                                                   {{ is_array($post->category) ? implode(', ', $post->category) : $post->category }}
                                                </span>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                @foreach ($recentPosts as $recent)
                                    <a href="{{ route('blog.show', $recent->slug) }}"
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-gray-400 text-xs">{{ $recent->published_at?->format('d M Y') }}
                                            </p>
                                            @if ($recent->author)
